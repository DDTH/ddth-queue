...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLSingleStorageQueueLong -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueLong extends BaseQueueLongTest {
