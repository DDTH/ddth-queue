...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLQueueLong -DenableTestsMySql=true
 */

public class TestMySQLQueueLong extends BaseQueueLongTest {
