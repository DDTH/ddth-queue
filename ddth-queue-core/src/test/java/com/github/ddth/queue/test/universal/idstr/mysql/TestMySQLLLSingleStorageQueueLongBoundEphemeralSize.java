...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLLLSingleStorageQueueLongBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLLLSingleStorageQueueLongBoundEphemeralSize extends BaseQueueLongTest<Long> {
    public TestMySQLLLSingleStorageQueueLongBoundEphemeralSize(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestMySQLLLSingleStorageQueueLongBoundEphemeralSize.class);
    }
