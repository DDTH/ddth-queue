...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mongodb.TestMongodbQueueLong -DenableTestsMongo=true
 */

public class TestMongodbQueueLong extends BaseQueueLongTest<String> {
