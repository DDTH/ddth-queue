...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mongodb.TestMongodbQueueMTBoundEphemeralSize -DenableTestsMongo=true
 */

public class TestMongodbQueueMTBoundEphemeralSize extends BaseQueueMultiThreadsTest<Long> {
