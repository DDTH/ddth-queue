...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLQueueMTBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLQueueMTBoundEphemeralSize extends BaseQueueMultiThreadsTest {
