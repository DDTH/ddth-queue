 ...
 */
public class TestInmemQueueBoundXSmallEphemeralDisabled extends BaseQueueMultiThreadsTest<String> {
    public TestInmemQueueBoundXSmallEphemeralDisabled(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestInmemQueueBoundXSmallEphemeralDisabled.class);
    }
