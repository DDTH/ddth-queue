...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.rocksdb.TestRocksDbQueueMT -DenableTestsRocksDb=true
 */

public class TestRocksDbQueueMT extends BaseQueueMultiThreadsTest<Long> {
