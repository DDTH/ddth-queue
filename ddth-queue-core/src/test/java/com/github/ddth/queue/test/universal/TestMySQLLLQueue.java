...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLLLQueue -DenableTestsMySql=true
 */
 ...
 * @since 0.5.0
 */
public class TestMySQLLLQueue extends BaseQueueFunctionalTest {
