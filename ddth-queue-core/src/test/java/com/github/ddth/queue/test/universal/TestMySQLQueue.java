...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLQueue -DenableTestsMySql=true
 */
 ...
 * @since 0.5.0
 */
public class TestMySQLQueue extends BaseQueueFunctionalTest {
