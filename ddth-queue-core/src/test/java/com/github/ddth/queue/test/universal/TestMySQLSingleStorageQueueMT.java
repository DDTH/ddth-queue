...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLSingleStorageQueueMT -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueMT extends BaseQueueMultiThreadsTest {
