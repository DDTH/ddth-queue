...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLSingleStorageQueueLongEphemeralDisabled -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueLongEphemeralDisabled extends BaseQueueLongTest {
