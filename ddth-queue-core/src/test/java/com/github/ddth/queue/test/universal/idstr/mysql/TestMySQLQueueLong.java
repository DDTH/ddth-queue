...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLQueueLong -DenableTestsMySql=true
 */

public class TestMySQLQueueLong extends BaseQueueLongTest<String> {
    public TestMySQLQueueLong(String testName) {
        super(testName);
    }
