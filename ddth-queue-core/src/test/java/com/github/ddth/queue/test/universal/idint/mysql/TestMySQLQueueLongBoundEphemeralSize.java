...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLQueueLongBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLQueueLongBoundEphemeralSize extends BaseQueueLongTest<Long> {
