...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLSingleStorageQueueLong -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueLong extends BaseQueueLongTest<String> {
