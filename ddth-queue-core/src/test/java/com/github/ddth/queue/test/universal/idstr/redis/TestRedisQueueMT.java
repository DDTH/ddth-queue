...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.redis.TestRedisQueueMT -DenableTestsRedis=true
 */

public class TestRedisQueueMT extends BaseQueueMultiThreadsTest<String> {
