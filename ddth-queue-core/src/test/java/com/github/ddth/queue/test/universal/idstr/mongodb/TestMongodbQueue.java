...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mongodb.TestMongodbQueue -DenableTestsMongo=true
 */

public class TestMongodbQueue extends BaseQueueFunctionalTest<String> {
