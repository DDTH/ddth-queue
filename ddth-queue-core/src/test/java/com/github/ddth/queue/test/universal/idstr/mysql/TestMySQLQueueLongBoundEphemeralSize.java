...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLQueueLongBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLQueueLongBoundEphemeralSize extends BaseQueueLongTest<String> {
