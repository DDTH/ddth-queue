...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLSingleStorageQueueMTBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueMTBoundEphemeralSize extends BaseQueueMultiThreadsTest<String> {
