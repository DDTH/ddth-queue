...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLSingleStorageQueueMTEphemeralDisabled -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueMTEphemeralDisabled extends BaseQueueMultiThreadsTest<Long> {
