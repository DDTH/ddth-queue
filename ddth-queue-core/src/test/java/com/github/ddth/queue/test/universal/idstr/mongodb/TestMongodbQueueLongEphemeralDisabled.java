...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mongodb.TestMongodbQueueLongEphemeralDisabled -DenableTestsMongo=true
 */

public class TestMongodbQueueLongEphemeralDisabled extends BaseQueueLongTest<String> {
