...
public class QndMultithreadRabbitMq {
    ...
    private static void createThreads(final UniversalRabbitMqQueue queue, int numThreads) {
    ...
    public static void main(String[] args) throws Exception {
        try (final UniversalRabbitMqQueue queue = new UniversalRabbitMqQueue()) {
            queue.setUri("amqp://guest:guest@localhost:5672").setQueueName(QUEUE).init();
