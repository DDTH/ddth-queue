...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mongodb.TestMongodbQueueMT -DenableTestsMongo=true
 */

public class TestMongodbQueueMT extends BaseQueueMultiThreadsTest<Long> {
