...
public class QndLessLockingQueueSingleStorageMySQL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (AbstractJdbcHelper jdbcHelper = new DdthJdbcHelper()) {
            ...
            try (LessLockingUniversalSingleStorageMySQLQueue queue = new LessLockingUniversalSingleStorageMySQLQueue()) {
                queue.setTableName("queuellss").setJdbcHelper(jdbcHelper)
                        .setQueueName(QndLessLockingQueueSingleStorageMySQL.class.getSimpleName())
                        .init();
