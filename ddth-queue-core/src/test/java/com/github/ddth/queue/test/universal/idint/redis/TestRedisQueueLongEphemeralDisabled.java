...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.redis.TestRedisQueueLongEphemeralDisabled -DenableTestsRedis=true
 */

public class TestRedisQueueLongEphemeralDisabled extends BaseQueueLongTest<Long> {
