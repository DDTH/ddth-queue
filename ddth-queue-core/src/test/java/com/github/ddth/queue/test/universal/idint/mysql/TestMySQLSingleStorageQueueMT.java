...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLSingleStorageQueueMT -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueMT extends BaseQueueMultiThreadsTest<Long> {
