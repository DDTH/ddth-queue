...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.rocksdb.TestRocksDbQueueMT -DenableTestsRocksDb=true
 */

public class TestRocksDbQueueMT extends BaseQueueMultiThreadsTest<String> {
