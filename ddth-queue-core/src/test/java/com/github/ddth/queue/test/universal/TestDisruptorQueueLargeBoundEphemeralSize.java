 ...
 */
public class TestDisruptorQueueLargeBoundEphemeralSize extends BaseQueueMultiThreadsTest {
    ...
    protected IQueue initQueueInstance() throws Exception {
        ...
        queue.setRingSize(8192).setEphemeralDisabled(false).setEphemeralMaxSize(8192 / 8).init();
        return queue;
    }
