...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mysql.TestMySQLLLQueue -DenableTestsMySql=true
 */
 ...
 * @since 0.5.0
 */
public class TestMySQLLLQueue extends BaseQueueFunctionalTest<String> {
    ...
    protected IQueue<String, byte[]> initQueueInstance(int ephemeralMaxSize) throws Exception {
        ...
        String tableQueue = System.getProperty("table.queue", "queuell2");
