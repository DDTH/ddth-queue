...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.rocksdb.TestRocksDbQueueLongEphemeralDisabled -DenableTestsRocksDb=true
 */

public class TestRocksDbQueueLongEphemeralDisabled extends BaseQueueLongTest<Long> {
