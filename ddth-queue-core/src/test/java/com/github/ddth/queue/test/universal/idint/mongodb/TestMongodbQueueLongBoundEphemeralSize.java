...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mongodb.TestMongodbQueueLongBoundEphemeralSize -DenableTestsMongo=true
 */

public class TestMongodbQueueLongBoundEphemeralSize extends BaseQueueLongTest<Long> {
