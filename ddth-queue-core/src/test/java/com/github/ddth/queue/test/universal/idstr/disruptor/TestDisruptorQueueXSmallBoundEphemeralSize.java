 ...
 */
public class TestDisruptorQueueXSmallBoundEphemeralSize extends BaseQueueMultiThreadsTest<String> {
    public TestDisruptorQueueXSmallBoundEphemeralSize(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestDisruptorQueueXSmallBoundEphemeralSize.class);
    }
