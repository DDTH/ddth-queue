...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLSingleStorageQueueMTBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueMTBoundEphemeralSize extends BaseQueueMultiThreadsTest {
