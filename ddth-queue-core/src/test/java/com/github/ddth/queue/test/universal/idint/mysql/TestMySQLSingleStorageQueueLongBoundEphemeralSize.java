...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLSingleStorageQueueLongBoundEphemeralSize -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueLongBoundEphemeralSize extends BaseQueueLongTest<Long> {
