...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLQueueMT -DenableTestsMySql=true
 */

public class TestMySQLQueueMT extends BaseQueueMultiThreadsTest {
