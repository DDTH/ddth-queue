...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLQueueLongEphemeralDisabled -DenableTestsMySql=true
 */

public class TestMySQLQueueLongEphemeralDisabled extends BaseQueueLongTest {
