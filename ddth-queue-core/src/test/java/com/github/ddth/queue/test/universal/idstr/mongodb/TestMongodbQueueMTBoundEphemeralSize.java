...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mongodb.TestMongodbQueueMTBoundEphemeralSize -DenableTestsMongo=true
 */

public class TestMongodbQueueMTBoundEphemeralSize extends BaseQueueMultiThreadsTest<String> {
    public TestMongodbQueueMTBoundEphemeralSize(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestMongodbQueueMTBoundEphemeralSize.class);
    }
