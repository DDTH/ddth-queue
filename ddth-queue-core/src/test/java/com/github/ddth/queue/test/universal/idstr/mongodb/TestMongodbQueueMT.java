...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idstr.mongodb.TestMongodbQueueMT -DenableTestsMongo=true
 */

public class TestMongodbQueueMT extends BaseQueueMultiThreadsTest<String> {
    public TestMongodbQueueMT(String testName) {
        super(testName);
    }
