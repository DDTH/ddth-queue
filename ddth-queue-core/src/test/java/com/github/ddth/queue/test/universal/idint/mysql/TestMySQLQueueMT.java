...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLQueueMT -DenableTestsMySql=true
 */

public class TestMySQLQueueMT extends BaseQueueMultiThreadsTest<Long> {
