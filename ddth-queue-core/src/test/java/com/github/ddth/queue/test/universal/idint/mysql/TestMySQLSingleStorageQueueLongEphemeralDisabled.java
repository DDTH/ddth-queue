...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLSingleStorageQueueLongEphemeralDisabled -DenableTestsMySql=true
 */

public class TestMySQLSingleStorageQueueLongEphemeralDisabled extends BaseQueueLongTest<Long> {
    public TestMySQLSingleStorageQueueLongEphemeralDisabled(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestMySQLSingleStorageQueueLongEphemeralDisabled.class);
    }
    ...
    protected IQueue<Long, byte[]> initQueueInstance() {
