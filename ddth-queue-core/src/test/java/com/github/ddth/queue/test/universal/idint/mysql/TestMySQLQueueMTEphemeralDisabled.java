...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.idint.mysql.TestMySQLQueueMTEphemeralDisabled -DenableTestsMySql=true
 */

public class TestMySQLQueueMTEphemeralDisabled extends BaseQueueMultiThreadsTest<Long> {
