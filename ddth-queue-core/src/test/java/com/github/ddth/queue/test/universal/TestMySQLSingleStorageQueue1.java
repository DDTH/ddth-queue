...
/*
 * mvn test -DskipTests=false -Dtest=com.github.ddth.queue.test.universal.TestMySQLSingleStorageQueue1 -DenableTestsMySql=true
 */
 ...
 * @since 0.5.2
 */
public class TestMySQLSingleStorageQueue1 extends BaseQueueFunctionalTest {
    public TestMySQLSingleStorageQueue1(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestMySQLSingleStorageQueue1.class);
    }
