 ...
 * @since 0.5.1.1
 */
public class AbstractLessLockingUniversalJdbcQueue
    ...
    protected int queueSize(Connection conn) {
        Map<String, Object> row = getJdbcHelper().executeSelectOne(conn, SQL_COUNT);
